...
namespace Marus.Communications.Acoustics
{
    ...
    public class NanomodemgRPC : MonoBehaviour
    {
        ...
        /// <summary>
        /// This method is called on every NanomodemRequest from gRPC side
        /// </summary>
        ...
        /// <summary>
        /// Parses reqest from gRPC side, communicates with other nanomodems if needed
        /// and sends back response/s to gRPC side if needed.
        /// </summary>
        public void ParseAndExecuteCommand(NanomodemRequest req)
        {
            ...
            else if(req.ReqType == NanomodemRequest.Types.Type.Chngid)
            {
                ...
                // re-initiate communication with gRPC server with new id
                streamer.StopStream();
                Awake();
            }
